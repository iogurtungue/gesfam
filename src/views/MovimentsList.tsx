...
export function MovimentsList({ seleccionats, categories }: Props) {
  ...
  const filtrats = useMemo(() => {
    ...
    // of whatever arbitrary order IndexedDB happened to return, and this
    // tiebreak is NOT flipped by the sort direction: reversing date order
    // shouldn't reverse a single day's internal chronology.
